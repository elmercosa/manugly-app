  ...
  return (
    <>
      <div className="z-10 w-full max-w-xl px-5 xl:px-0">
        ...
        >
          <Balancer>Let the uglyman do it for you</Balancer>
        </h1>
        <p
        ...
        >
          <Balancer>
            Reserva tu cita con el uglyman y el hará el trabajo por ti
          </Balancer>
        </p>
        <div
        ...
        >
          ...
          >
            ...
            <p>
              ...
              <span className="font-semibold">{nFormatter(50)}</span>
            </p>
          </a>
        </div>
      </div>

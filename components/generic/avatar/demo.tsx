...
import {
  ...
  AvatarSize,
  AvatarRadius,
} from "@/components/generic/avatar/avatar.types";
  ...
  return (
    <div className="flex flex-col gap-4">
      <div className="flex flex-col gap-2">
        <h2 className="text-4xl font-bold" id="avatar">
          Avatares
        </h2>
        <p>
        ...
        <Snippet text="import Avatar from '@/components/generic/avatar/avatar'"></Snippet>

        <h3 className="text-xl">Tipos</h3>
        <Snippet text="import { AvatarColor, AvatarSize, AvatarRadius} from '@/components/generic/avatar/avatar.types'"></Snippet>
      </div>
      <div className="flex flex-col gap-2">

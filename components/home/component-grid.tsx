  ...
  return (
    <div className="grid grid-cols-1 gap-5 md:grid-cols-3">
      ...
      <button
        ...
        className="flex items-center justify-center px-3 py-2 transition-all duration-75 border border-gray-300 rounded-md w-36 hover:border-gray-800 focus:outline-none active:bg-gray-100"
      >
      ...
      <Tooltip content="Precedent is an opinionated collection of components, hooks, and utilities for your Next.js project.">
        <div className="flex items-center justify-center px-3 py-2 transition-all duration-75 border border-gray-300 rounded-md cursor-default w-36 hover:border-gray-800 focus:outline-none active:bg-gray-100">
